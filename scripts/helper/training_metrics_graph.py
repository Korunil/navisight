...
# ----------------------------------------------------------------------
epochs = np.array([2, 3, 4, 5, 6, 7, 8, 9, 11, 12, 13, 14, 15])

loss = np.array([0.00948, 0.00716, 0.00594, 0.00535, 0.00481, 0.00446, 
                  0.00427, 0.00405, 0.00380, 0.00383, 0.00358, 0.00350, 0.00347])

eff_rank = np.array([66.2, 65.1, 63.1, 62.0, 61.1, 60.2, 59.7, 59.2, 
                     57.2, 56.6, 56.1, 55.8, 55.0])

mean_cos = np.array([0.1950, 0.2123, 0.2100, 0.1900, 0.1837, 0.1824, 
                     0.1821, 0.1739, 0.1665, 0.1627, 0.1568, 0.1516, 0.1577])

latent_var = np.array([0.0063, 0.0061, 0.0062, 0.0063, 0.0064, 0.0064, 
                       0.0064, 0.0065, 0.0065, 0.0065, 0.0066, 0.0066, 0.0066])
...
ax_a.set_ylim(0.002, 0.010)  # USER SPECIFIED SPECIFICATION BOUNDARY
ax_a.set_xticks(np.arange(2, 16, 1))
...
ax_b1.set_xlim(1.5, 15.5)
ax_b1.set_ylim(40, 100)  # USER SPECIFIED SPECIFICATION BOUNDARY
ax_b1.set_xticks(np.arange(2, 16, 1))
...
ax_b2.set_ylim(0.00, 0.30)  # USER SPECIFIED SPECIFICATION BOUNDARY
...
ax_b3.set_ylim(0.004, 0.010)  # USER SPECIFIED SPECIFICATION BOUNDARY
