        ...
        with self.lock:
            ...
            if vessel_id_int in self.state_map:
                ...
                if global_lsn < current_state.global_lsn:
                    return
                existing_offset = current_state.trip_id_offset
                
            # Dynamically resolve trip_id_offset, falling back to historical memory state if missing
            resolved_offset = int(record_data.get("trip_id_offset", existing_offset))
            ...
            new_value = VesselStateValue(
                ...
                trip_id_offset=resolved_offset
            )
